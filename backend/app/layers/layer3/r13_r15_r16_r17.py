...
from app.utils.text_cleaner import extract_clean_text, soup_to_clean_text

from app.utils.fetcher import safe_get, jitter_sleep
from app.utils.embedder import embed, cosine_sim, chunk_text, embed_batch
